      ...
      >
        ...
        >
          <div className={`${styles.navbar_nav} ml-auto p-4`}>
            <Link
              href="/"
              className={`${styles.nav_link} ${route.route=="/"?styles.active_nav_link:""}`}
            >
              Home
            </Link>

            <Link href="/about" className={`${styles.nav_link} ${route.route=="/about"?styles.active_nav_link:""}`}>
              About
            </Link>
            <Link href="/services" className={`${styles.nav_link} ${route.route=="/services"?styles.active_nav_link:""}`}>
              Services
            </Link>
            <Link href="/menu" className={`${styles.nav_link} ${route.route=="/menu"?styles.active_nav_link:""}`}>
              Menu
            </Link>
            ...
            <div className={`${styles.dropdown}`}>
              <a
                href="#"
                className={`${styles.nav_link} ${styles.dropdown_toggle} ${route.route=="/reservation"||route.route=="/testimonial"?styles.active_nav_link:""}`}
            ...
            <Link href="/contact" className={`${styles.nav_link} ${route.route=="/contact"?styles.active_nav_link:""}`}>
              Contact
            </Link>
          </div>
        </div>
